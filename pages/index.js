          ...
          <div className="mockup-phone">
            ...
            <div className="display">
              <div className="flex items-center justify-center artboard artboard-demo phone-1">
                ...
                <a href="/add-token?name=Tether&symbol=USDT&decimals=6&address=0xdAC17F958D2ee523a2206206994597C13D831ec7&imgUrl=https://cryptologos.cc/logos/tether-usdt-logo.png?v=022" className="mt-4 btn btn-wide btn-outline btn-warning">Add Ethereum Tether Token</a>
                <a href="/add-token?name=Wrapped%20BNB&symbol=WBNB&decimals=18&address=0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c&imgUrl=https://cryptologos.cc/logos/bnb-bnb-logo.png?v=022" className="mt-2 btn btn-wide btn-outline btn-info">Add BSC Wrapped BNB Token</a>
              </div>
            </div>
          </div>
          ...
          <div className="mt-10 md:mt-0 mockup-phone">
            ...
            <div className="display">
              <div className="flex items-center justify-center artboard artboard-demo phone-1">
                ...
                <a href="/add-chain?chainId=137&chainName=Polygon&rpcUrl=https://polygon-rpc.com&blockExplorerUrl=https://polygonscan.com&iconUrl=https://cryptologos.cc/logos/polygon-matic-logo.png?v=022&currencyName=Matic&currencySymbol=MATIC&currencyDecimals=18" className="mt-4 btn btn-wide btn-outline btn-secondary">Add Polygon Chain</a>
                <a href="/add-chain?chainId=56&chainName=Binance%20Smart%20Chain&rpcUrl=https://bsc-dataseed1.ninicoin.io&blockExplorerUrl=https://bscscan.com&iconUrl=https://cryptologos.cc/logos/bnb-bnb-logo.png?v=022&currencyName=Binance&currencySymbol=BNB&currencyDecimals=18" className="mt-2 btn btn-wide btn-outline btn-warning">Add BSC Chain</a>
                <a href="/add-chain?chainId=250&chainName=Fantom%20Opera&rpcUrl=https://rpcapi.fantom.network/&blockExplorerUrl=https://ftmscan.com/&iconUrl=https://cryptologos.cc/logos/fantom-ftm-logo.png?v=022&currencyName=Fantom&currencySymbol=FTM&currencyDecimals=18" className="mt-2 btn btn-wide btn-outline btn-info">Add Fantom Chain</a>
                <a href="/add-chain?chainId=43114&chainName=Avalanche&rpcUrl=https://api.avax.network/ext/bc/C/rpc&blockExplorerUrl=https://snowtrace.io&iconUrl=https://cryptologos.cc/logos/avalanche-avax-logo.png?v=022&currencyName=Avalanche&currencySymbol=AVAX&currencyDecimals=18" className="mt-2 btn btn-wide btn-outline btn-error">Add Avalanche Chain</a>
              </div>
            </div>
          </div>
          ...
          <div className="mt-10 md:mt-0 mockup-phone">
            ...
            <div className="display">
              <div className="flex items-center justify-center artboard artboard-demo phone-1">
                ...
                <code className="px-3 text-gray-800 bg-gray-100">{"chainId=<CHAIN_ID>"}</code>
                <a href="/switch-chain?chainId=137" className="mt-4 btn btn-wide btn-outline btn-secondary">Switch To Polygon Chain</a>
                <a href="/switch-chain?chainId=56" className="mt-2 btn btn-wide btn-outline btn-warning">Switch To BSC Chain</a>
                <a href="/switch-chain?chainId=250" className="mt-2 btn btn-wide btn-outline btn-info">Switch To Fantom Chain</a>
                <a href="/switch-chain?chainId=43114" className="mt-2 btn btn-wide btn-outline btn-error">Switch To Avalanche Chain</a>
              </div>
            </div>
          </div>
